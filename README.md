...
> [!IMPORTANT]
> This fork packages Grafana Alloy for Asuswrt-Merlin/AMTM routers. The first
> supported target is the ASUS RT-BE88U (`linux/arm64`). See the
> [AMTM installation guide](docs/amtm/README.md). General Alloy documentation
> below is inherited from upstream.
